...
const Home = () => {
  ...
  const [isDownloadClicked, setIsDownloadClicked] = useState(false); // State to track if download button is clicked
  ...
  const handleDownloadClick = () => {
    toPDF();
    setIsDownloadClicked(true); // Set the state to true when download button is clicked
  };
  ...
  return (
    <div className="flex font-serif ">
      <div className="m-10">
        ...
        <button
          onClick={handleDownloadClick} // Call handleDownloadClick function
      ...
      {/* Conditionally render template div based on isDownloadClicked state */}
      {isDownloadClicked && (
        <div
          ref={targetRef}
